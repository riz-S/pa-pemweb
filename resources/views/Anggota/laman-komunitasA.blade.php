                ...
                <div class="card author-box card-primary">
                  <div class="card-body">
                    <div class="author-box-left">
                      ...
                      @if($joined==-1)
                        <br>
                        <a href="{{route('joinKomunitas.anggota',[$komunitas->komunitasId])}}" class="btn btn-danger btn-icon icon-right">Gabung</a>
                      @elseif($joined)
                        <br>
                    ...
                    <div class="author-box-details">
                      <div class="author-box-name">
                        ...
                        @if($joined===1)
                          <a href="{{route('leaveKomunitas.anggota',[$komunitas->komunitasId])}}" class="badge badge-danger float-right">Leave komunitas</a>
                        @endif
                      </div>
                ...
                <div class="card card-danger">
                  <div class="card-header">
                    ...
                    <div class="card-header-action">
                      <a href="{{route('showAllAnggota.anggota',[$komunitas->komunitasId])}}" class="btn btn-danger btn-icon icon-right">Selengkapnya <i class="fas fa-chevron-right"></i></a>
                    </div>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-12 col-sm-12 col-lg-12">
                <div class="card card-info">
                  ...
                  <div class="card-body">
                    ...
                    @else
                      <h5 class="text-center">Belum ada divisi</h5>
                    @endif
                  </div>
                </div>
              </div>
              ...
              <div class="col-12 col-sm-12 col-lg-12">
                <div class="card card-info">
                  ...
                  <div class="card-body">
                    ...
                    @else
                      <h5 class="text-center">Belum ada proker</h5>
                    @endif
                  </div>
                </div>
              </div>
