                            ...
                            <tr>
                              ...
                              @if($joined===1)
                                @if($anggota->userId!=$mine)
                                  <td><a href="{{route('showDetailAnggota.anggota',[$anggota->anggotaId])}}" class="btn {{($anggota->statusacc==0)?'disabled':''}} btn-info">Hubungi</a></td>
                                @else
                                  <td><a href="{{route('showEditAnggota.anggota',[$anggota->anggotaId])}}" class="btn btn-danger">Edit</a></td>
                                @endif
                              @endif
                            </tr>
                          @endforeach
