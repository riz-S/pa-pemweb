...
<head>
  ...
  <title>Tambah divisi | {{$komunitas->nama}}</title>
          ...
          <div class="section-body">
            <div class="row mt-sm-4">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">  
                  <div class="card-body">
                    <form method="POST" action="{{route('createDivisi.ketua',[$komunitas->komunitasId])}}" enctype="multipart/form-data">
                      @csrf
                      <div class="section-title mt-0">Data Divisi</div>
                      <div class="row">
