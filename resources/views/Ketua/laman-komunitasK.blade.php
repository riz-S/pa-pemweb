...
<head>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="{{asset('assets/backup/css/bootstrap-social.css')}}">
        ...
        <section class="section">
          ...
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">{{$komunitas->nama}}</div>
            </div>
          </div>
                ...
                <div class="card author-box card-primary">
                  <div class="card-body">
                    <div class="author-box-left">
                      ...
                      <br>
                      <a href="{{route('editKomunitas.ketua',[$komunitas->komunitasId])}}" class="btn btn-warning btn-icon icon-right">Edit</a>
                    </div>
                ...
                <div class="card card-danger">
                  <div class="card-header">
                    ...
                    <div class="card-header-action">
                      <a href="{{route('showAllAnggota.anggota',[$komunitas->komunitasId])}}" class="btn btn-danger btn-icon icon-right">
                            ...
                            <div class="user-details">
                              ...
                              <div class="user-cta">
                                @if($anggota->userId!=$mine)
                                  <a href ="{{route('showDetailAnggota.anggota',[$anggota->anggotaId])}}"><button class="btn btn-primary ">Hubungi</button></a>
                                @else
                                  <a href ="{{route('showEditAnggota.anggota',[$anggota->anggotaId])}}"><button class="btn btn-warning ">Edit</button></a>
                                @endif
                              </div>
                            </div>
                          </div>
              ...
              <div class="col-12 col-sm-12 col-lg-12">
                <div class="card card-info">
                  <div class="card-header">
                    <h4>Divisi</h4>
                    <div class="card-header-action">
                      <a href="{{route('tambahDivisi.ketua',[$komunitas->komunitasId])}}" class="btn btn-info">
                        Tambah Divisi</a>
                    </div>
                  </div>  
                  <div class="card-body">
                          ...
                          <li class="media">
                            ...
                            <div class="media-body">
                              <div class="media-right">
                                <a href="{{route('editDivisi.ketua',[$divisi->divisiId])}}" class="btn btn-warning">Edit</a>
                                <a href="{{route('deleteDivisi.ketua',[$divisi->divisiId])}}" class="btn btn-danger">Delete</a>
                              </div>
              ...
              <div class="col-12 col-sm-12 col-lg-12">
                <div class="card card-info">
                  <div class="card-header">
                    <h4>Program Kerja</h4>
                    <div class="card-header-action">
                      <a href="{{route('tambahProker.ketua',[$komunitas->komunitasId])}}" class="btn btn-info">
                        Tambah Proker</a>
                    </div>
                  </div>
                  <div class="card-body">
                      ...
                      <ul class="list-unstyled list-unstyled-border list-unstyled-noborder">
                        @foreach($prokers as $proker)
                          <li class="media">
                            ...
                            <div class="media-body">
                              <div class="media-right">
                                <a href="{{route('editProker.ketua',[$proker->prokerId])}}" class="btn btn-warning">Edit</a>
                                <a href="{{route('deleteProker.ketua',[$proker->prokerId])}}" class="btn btn-danger">Delete</a>
                              </div>
            ...
            <div class ="row">
              <div class="col-12 col-sm-12 col-lg-12">
                <div class="card card-warning">
                  ...
                  <div class="card-body">
                    @if($anggotas->contains('statusacc',0))
                      @foreach($anggotas as $anggota)
                        @if($anggota->statusacc==0)
                          <ul class="list-unstyled user-progress list-unstyled-border list-unstyled-noborder">
                            <li class="media">
                              <?php $foto = isset($anggota->foto)?$anggota->foto:'default.png';?>
                              <img alt="image" class="mr-3 rounded-circle" width="50" src="{{asset("assets/img/profil/$foto")}}">
                              <div class="media-body">
                                <div class="media-title">{{$anggota->nama}}</div>
                                <div class="text-muted">{{$anggota->deskripsi}}</div>
                              </div>
                              <div class="media-cta">
                                <form action="{{route('accAnggota.ketua',[$komunitas->komunitasId])}}" method="post">
                                  @csrf
                                  <button name="answer" type="submit" class="btn btn-success" value="acc|{{$anggota->anggotaId}}">Terima</button>
                                  <button name="answer" type="submit" class="btn btn-danger" value="unacc|{{$anggota->anggotaId}}">Tolak</button>
                                </form>
                              </div>
                            </li>
                          </ul>
