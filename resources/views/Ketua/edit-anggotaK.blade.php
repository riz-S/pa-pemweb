                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="form-group col-6">
                          ...
                          @if($anggota->jabatanId!=1)
                            <select class="form-control selectric" name="jabatan" >
                              @foreach($listJabatan as $jabatan)
                                @if($jabatan->jabatanId==$anggota->jabatanId)
                                  <option selected value="{{$jabatan->jabatanId}}">{{$jabatan->nama}}</option>
                                @else
                                  <option value="{{$jabatan->jabatanId}}">{{$jabatan->nama}}</option>
                                @endif
                              @endforeach
                            </select>
                          @else
                        ...
                        <div class="form-group col-6">
                          ...
                          <select class="form-control selectric" name="divisi">
                            ...
                            @foreach($listDivisi as $divisi)
                              @if($divisi->divisiId==$anggota->divisiId)
                                <option selected value="{{$divisi->divisiId}}">{{$divisi->nama}}</option>
                              @else
