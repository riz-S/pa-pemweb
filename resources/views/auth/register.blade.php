            ...
            <div class="row">
              <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                ...
                <div class="card card-primary">
                  <div class="card-body">
                    <form method="POST" action="{{ route('sendregis') }}">
                    @csrf
                    <div class="form-divider">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-12">
                          ...
                          <input id="emai" type="text" class="form-control" name="email" >
                        </div>
                        <div class="form-group col-6">
                          <label for="telepon">No Telepon</label>
                          <input id="telepon" type="tel" class="form-control phone-number" name="noTelp" >
                        </div>
                        <div class="form-group col-6">
                          <label>Fakultas</label>
                          <?php $listFakultas = ['FILKOM','FIA','FEB','FH','FIB','FISIP','FK','FKG','FPIK','FP','FAPET','FT','FTP','FMIPA']?>
                ...
                <div class="simple-footer">
                  Copyright &copy; Kelompok 6 2021
                </div>
              </div>
            </div>
          </div>
