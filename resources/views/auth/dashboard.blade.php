...
<body class="layout-3">
  <div id="app">
    <div class="main-wrapper container">
      ...
      <?php //include '../resources/components/navbar-2.php';?>
    <x-navbar-2>
              ...
              <div class="col-12 col-sm-12 col-lg-12">
                  <div class="card">
                    <div class="card-header">
                      <h4>Lembaga Otonom (LO)</h4>
                    </div>
                    <div class="card-body">
                      <ul class="list-unstyled list-unstyled-border list-unstyled-noborder">
                        <li class="media">
                        
                          <img alt="image" class="mr-3 rounded-circle" width="70" src="{{asset('assets/img/bem.png')}}">
                          <div class="media-body">
                            <div class="media-right"><a href="laman-komunitas.php" class="text-primary">Selengkapnya</a></div>
                            <div class="media-title mb-1">Badan Eksekutif Mahasiswa</div>
                            <div class="text-time">Lembaga Otonom</div>
                        ...
                        <li class="media">
                          <img alt="image" class="mr-3 rounded-circle" width="70" src="{{asset('assets/img/hmif')}}.jpg">
                          <div class="media-body">
                            <div class="media-right"><a href="#" class="btn btn-info">Selengkapnya</a></div>
                            <div class="media-title mb-1">Himpunan Mahasiswa Informatika</div>
                            <div class="text-time">Lembaga Otonom</div>
                        ...
                        <li class="media">
                          <img alt="image" class="mr-3 rounded-circle" width="70" src="assets/img/kbmsi.jpg">
                          <div class="media-body">
                            <div class="media-right"><a href="#" class="btn btn-info">Selengkapnya</a></div>
                            <div class="media-title mb-1">Keluarga Besar Mahasiswa Sistem Informasi</div>
                            <div class="text-time">Lembaga Otonom</div>
                            <div class="media-description text-muted">Duis aute irure dolor in reprehenderit in voluptate velit esse
                            cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
                            proident</div>
                  ...
                  <div class="card-body">
                    <ul class="list-unstyled list-unstyled-border list-unstyled-noborder">
                      <li class="media">
                        ...
                        <div class="media-body">
                          <div class="media-right"><a href="#" class="text-primary">Selengkapnya</a></div>
                      ...
                      <li class="media">
                        <img alt="image" class="mr-3 rounded-circle" width="70" src="{{asset('assets/img/bios')}}.jpg">
                        <div class="media-body">
                          <div class="media-right"><a href="#" class="btn btn-info">Selengkapnya</a></div>
                      ...
                      <li class="media">
                        <img alt="image" class="mr-3 rounded-circle" width="70" src="{{asset('assets/img/raion')}}.png">
                        <div class="media-body">
                          <div class="media-right"><a href="#" class="btn btn-info">Selengkapnya</a></div>
