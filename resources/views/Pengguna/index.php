...
<body class="layout-3">
  <div id="app">
    <div class="main-wrapper container">
      ...
      <?php include 'components/navbar-visitor.php';?>
                    ...
                    <div class="card-body">
                      <ul class="list-unstyled list-unstyled-border list-unstyled-noborder">
                        <li class="media">
                          ...
                          <img alt="image" class="mr-3 rounded-circle" width="70" src="assets/img/bem.png">
                        ...
                        <li class="media">
                          <img alt="image" class="mr-3 rounded-circle" width="70" src="assets/img/hmif.jpg">
                          <div class="media-body">
